...
template<class GtkObj, size_t N> struct Signals {};

template<> struct Signals<GtkAboutDialog, 0> {
...
template<> struct Signals<GtkAppChooserWidget, 0> {
...
template<> struct Signals<GtkAppChooserWidget, 1> {
    static constexpr const char* name() { return "application-selected"; }
    using callback_type = void(GtkAppChooserWidget*, GAppInfo* application, gpointer user_data);
};
template<> struct Signals<GtkAppChooserWidget, 2> {
...
template<> struct Signals<GtkCellArea, 2> {
...
template<> struct Signals<GtkCellArea, 3> {
...
template<> struct Signals<GtkCellRendererAccel, 0> {
...
template<> struct Signals<GtkCellRendererAccel, 1> {
    static constexpr const char* name() { return "accel-edited"; }
    using callback_type = void(GtkCellRendererAccel*, char* path_string, guint accel_key, GdkModifierType accel_mods, guint hardware_keycode, gpointer user_data);
};

template<> struct Signals<GtkCellRendererCombo, 0> {
    static constexpr const char* name() { return "changed"; }
    using callback_type = void(GtkCellRendererCombo*, char* path_string, GtkTreeIter* new_iter, gpointer user_data);
};

template<> struct Signals<GtkCellRendererText, 0> {
...
template<> struct Signals<GtkCellRendererToggle, 0> {
...
template<> struct Signals<GtkComboBox, 0> {
    static constexpr const char* name() { return "changed"; }
    using callback_type = void(GtkComboBox*, gpointer user_data);
};
template<> struct Signals<GtkComboBox, 1> {
...
template<> struct Signals<GtkEditable, 2> {
    static constexpr const char* name() { return "insert-text"; }
    using callback_type = void(GtkEditable*, char* new_text, int new_text_length, gpointer position, gpointer user_data);
};

template<> struct Signals<GtkEntry, 0> {
    static constexpr const char* name() { return "activate"; }
    using callback_type = void(GtkEntry*, gpointer user_data);
};
template<> struct Signals<GtkEntry, 1> {
    static constexpr const char* name() { return "backspace"; }
    using callback_type = void(GtkEntry*, gpointer user_data);
};
template<> struct Signals<GtkEntry, 2> {
    static constexpr const char* name() { return "copy-clipboard"; }
    using callback_type = void(GtkEntry*, gpointer user_data);
};
template<> struct Signals<GtkEntry, 3> {
    static constexpr const char* name() { return "cut-clipboard"; }
    using callback_type = void(GtkEntry*, gpointer user_data);
};
template<> struct Signals<GtkEntry, 4> {
...
template<> struct Signals<GtkEntry, 5> {
...
template<> struct Signals<GtkEntryBuffer, 1> {
...
template<> struct Signals<GtkEntryCompletion, 0> {
...
template<> struct Signals<GtkEntryCompletion, 1> {
...
template<> struct Signals<GtkEntryCompletion, 2> {
...
template<> struct Signals<GtkEventControllerKey, 4> {
...
template<> struct Signals<GtkEventControllerKey, 5> {
...
template<> struct Signals<GtkEventControllerMotion, 0> {
    static constexpr const char* name() { return "enter"; }
    using callback_type = void(GtkEventControllerMotion*, double x, double y, gpointer user_data);
};
template<> struct Signals<GtkEventControllerMotion, 1> {
    static constexpr const char* name() { return "leave"; }
    using callback_type = void(GtkEventControllerMotion*, gpointer user_data);
};
template<> struct Signals<GtkEventControllerMotion, 2> {
    static constexpr const char* name() { return "motion"; }
    using callback_type = void(GtkEventControllerMotion*, double x, double y, gpointer user_data);
};

template<> struct Signals<GtkEventControllerScroll, 0> {
...
template<> struct Signals<GtkEventControllerScroll, 1> {
...
template<> struct Signals<GtkFileChooserWidget, 4> {
    static constexpr const char* name() { return "location-popup-on-paste"; }
    using callback_type = void(GtkFileChooserWidget*, gpointer user_data);
};
template<> struct Signals<GtkFileChooserWidget, 5> {
    static constexpr const char* name() { return "location-toggle-popup"; }
    using callback_type = void(GtkFileChooserWidget*, gpointer user_data);
};
template<> struct Signals<GtkFileChooserWidget, 6> {
    static constexpr const char* name() { return "places-shortcut"; }
    using callback_type = void(GtkFileChooserWidget*, gpointer user_data);
};
template<> struct Signals<GtkFileChooserWidget, 7> {
...
template<> struct Signals<GtkGLArea, 0> {
...
template<> struct Signals<GtkGesture, 1> {
    static constexpr const char* name() { return "cancel"; }
    using callback_type = void(GtkGesture*, GdkEventSequence* sequence, gpointer user_data);
};
template<> struct Signals<GtkGesture, 2> {
    static constexpr const char* name() { return "end"; }
    using callback_type = void(GtkGesture*, GdkEventSequence* sequence, gpointer user_data);
};
template<> struct Signals<GtkGesture, 3> {
...
template<> struct Signals<GtkGesture, 4> {
    static constexpr const char* name() { return "update"; }
    using callback_type = void(GtkGesture*, GdkEventSequence* sequence, gpointer user_data);
};

template<> struct Signals<GtkGestureDrag, 0> {
...
template<> struct Signals<GtkGestureDrag, 1> {
...
template<> struct Signals<GtkGestureRotate, 0> {
...
template<> struct Signals<GtkGestureStylus, 0> {
...
template<> struct Signals<GtkGestureStylus, 1> {
    static constexpr const char* name() { return "motion"; }
    using callback_type = void(GtkGestureStylus*, double arg1, double arg2, gpointer user_data);
};
template<> struct Signals<GtkGestureStylus, 2> {
    static constexpr const char* name() { return "proximity"; }
    using callback_type = void(GtkGestureStylus*, double arg1, double arg2, gpointer user_data);
};
template<> struct Signals<GtkGestureStylus, 3> {
    static constexpr const char* name() { return "up"; }
    using callback_type = void(GtkGestureStylus*, double arg1, double arg2, gpointer user_data);
};

template<> struct Signals<GtkGestureSwipe, 0> {
...
template<> struct Signals<GtkGestureZoom, 0> {
...
template<> struct Signals<GtkListBox, 3> {
    static constexpr const char* name() { return "row-selected"; }
    using callback_type = void(GtkListBox*, GtkListBoxRow* row, gpointer user_data);
};
template<> struct Signals<GtkListBox, 4> {
    static constexpr const char* name() { return "select-all"; }
    using callback_type = void(GtkListBox*, gpointer user_data);
};
template<> struct Signals<GtkListBox, 5> {
    static constexpr const char* name() { return "selected-rows-changed"; }
    using callback_type = void(GtkListBox*, gpointer user_data);
};
template<> struct Signals<GtkListBox, 6> {
    static constexpr const char* name() { return "toggle-cursor-row"; }
    using callback_type = void(GtkListBox*, gpointer user_data);
};
template<> struct Signals<GtkListBox, 7> {
    static constexpr const char* name() { return "unselect-all"; }
    using callback_type = void(GtkListBox*, gpointer user_data);
};

template<> struct Signals<GtkListBoxRow, 0> {
    static constexpr const char* name() { return "activate"; }
    using callback_type = void(GtkListBoxRow*, gpointer user_data);
};

template<> struct Signals<GtkMenu, 0> {
...
template<> struct Signals<GtkMenu, 1> {
    static constexpr const char* name() { return "popped-up"; }
    using callback_type = void(GtkMenu*, gpointer flipped_rect, gpointer final_rect, gboolean flipped_x, gboolean flipped_y, gpointer user_data);
};

template<> struct Signals<GtkMenuItem, 0> {
    static constexpr const char* name() { return "activate"; }
    using callback_type = void(GtkMenuItem*, gpointer user_data);
};
template<> struct Signals<GtkMenuItem, 1> {
    static constexpr const char* name() { return "activate-item"; }
    using callback_type = void(GtkMenuItem*, gpointer user_data);
};
template<> struct Signals<GtkMenuItem, 2> {
    static constexpr const char* name() { return "deselect"; }
    using callback_type = void(GtkMenuItem*, gpointer user_data);
};
template<> struct Signals<GtkMenuItem, 3> {
    static constexpr const char* name() { return "select"; }
    using callback_type = void(GtkMenuItem*, gpointer user_data);
};
template<> struct Signals<GtkMenuItem, 4> {
...
template<> struct Signals<GtkMenuItem, 5> {
...
template<> struct Signals<GtkMenuShell, 0> {
...
template<> struct Signals<GtkMenuShell, 1> {
    static constexpr const char* name() { return "cancel"; }
    using callback_type = void(GtkMenuShell*, gpointer user_data);
};
template<> struct Signals<GtkMenuShell, 2> {
...
template<> struct Signals<GtkMenuShell, 3> {
    static constexpr const char* name() { return "deactivate"; }
    using callback_type = void(GtkMenuShell*, gpointer user_data);
};
template<> struct Signals<GtkMenuShell, 4> {
...
template<> struct Signals<GtkMenuShell, 5> {
...
template<> struct Signals<GtkMenuShell, 6> {
...
template<> struct Signals<GtkNotebook, 1> {
...
template<> struct Signals<GtkNotebook, 2> {
...
template<> struct Signals<GtkNotebook, 3> {
...
template<> struct Signals<GtkNotebook, 4> {
    static constexpr const char* name() { return "page-removed"; }
    using callback_type = void(GtkNotebook*, GtkWidget* child, guint page_num, gpointer user_data);
};
template<> struct Signals<GtkNotebook, 5> {
    static constexpr const char* name() { return "page-reordered"; }
    using callback_type = void(GtkNotebook*, GtkWidget* child, guint page_num, gpointer user_data);
};
template<> struct Signals<GtkNotebook, 6> {
...
template<> struct Signals<GtkNotebook, 7> {
...
template<> struct Signals<GtkNotebook, 8> {
...
template<> struct Signals<GtkOverlay, 0> {
...
template<> struct Signals<GtkPaned, 3> {
    static constexpr const char* name() { return "cycle-handle-focus"; }
    using callback_type = gboolean(GtkPaned*, gboolean reversed, gpointer user_data);
};
template<> struct Signals<GtkPaned, 4> {
...
template<> struct Signals<GtkPaned, 5> {
    static constexpr const char* name() { return "toggle-handle-focus"; }
    using callback_type = gboolean(GtkPaned*, gpointer user_data);
};

template<> struct Signals<GtkPlacesSidebar, 0> {
...
template<> struct Signals<GtkPlacesSidebar, 1> {
    static constexpr const char* name() { return "drag-action-requested"; }
    using callback_type = int(GtkPlacesSidebar*, GdkDragContext* context, GObject* dest_file, gpointer source_file_list, gpointer user_data);
};
template<> struct Signals<GtkPlacesSidebar, 2> {
    static constexpr const char* name() { return "drag-perform-drop"; }
    using callback_type = void(GtkPlacesSidebar*, GObject* dest_file, gpointer source_file_list, int action, gpointer user_data);
};
template<> struct Signals<GtkPlacesSidebar, 3> {
...
template<> struct Signals<GtkPlacesSidebar, 4> {
...
template<> struct Signals<GtkPlacesSidebar, 5> {
    static constexpr const char* name() { return "populate-popup"; }
    using callback_type = void(GtkPlacesSidebar*, GtkWidget* container, GFile* selected_item, GVolume* selected_volume, gpointer user_data);
};
template<> struct Signals<GtkPlacesSidebar, 6> {
...
template<> struct Signals<GtkPlacesSidebar, 7> {
    static constexpr const char* name() { return "show-enter-location"; }
    using callback_type = void(GtkPlacesSidebar*, gpointer user_data);
};
template<> struct Signals<GtkPlacesSidebar, 8> {
...
template<> struct Signals<GtkPlacesSidebar, 9> {
    static constexpr const char* name() { return "show-other-locations"; }
    using callback_type = void(GtkPlacesSidebar*, gpointer user_data);
};
template<> struct Signals<GtkPlacesSidebar, 10> {
...
template<> struct Signals<GtkRange, 2> {
...
template<> struct Signals<GtkRange, 3> {
    static constexpr const char* name() { return "value-changed"; }
    using callback_type = void(GtkRange*, gpointer user_data);
};

template<> struct Signals<GtkRecentChooser, 0> {
    static constexpr const char* name() { return "item-activated"; }
    using callback_type = void(GtkRecentChooser*, gpointer user_data);
};
template<> struct Signals<GtkRecentChooser, 1> {
    static constexpr const char* name() { return "selection-changed"; }
    using callback_type = void(GtkRecentChooser*, gpointer user_data);
};

template<> struct Signals<GtkRecentManager, 0> {
    static constexpr const char* name() { return "changed"; }
    using callback_type = void(GtkRecentManager*, gpointer user_data);
};

template<> struct Signals<GtkScaleButton, 0> {
    static constexpr const char* name() { return "popdown"; }
    using callback_type = void(GtkScaleButton*, gpointer user_data);
};
template<> struct Signals<GtkScaleButton, 1> {
    static constexpr const char* name() { return "popup"; }
    using callback_type = void(GtkScaleButton*, gpointer user_data);
};
template<> struct Signals<GtkScaleButton, 2> {
    static constexpr const char* name() { return "value-changed"; }
    using callback_type = void(GtkScaleButton*, double value, gpointer user_data);
};

template<> struct Signals<GtkScrolledWindow, 0> {
...
template<> struct Signals<GtkTextBuffer, 0> {
    static constexpr const char* name() { return "apply-tag"; }
    using callback_type = void(GtkTextBuffer*, GtkTextTag* tag, GtkTextIter* start, GtkTextIter* end, gpointer user_data);
};
template<> struct Signals<GtkTextBuffer, 1> {
    static constexpr const char* name() { return "begin-user-action"; }
    using callback_type = void(GtkTextBuffer*, gpointer user_data);
};
template<> struct Signals<GtkTextBuffer, 2> {
    static constexpr const char* name() { return "changed"; }
    using callback_type = void(GtkTextBuffer*, gpointer user_data);
};
template<> struct Signals<GtkTextBuffer, 3> {
...
template<> struct Signals<GtkTextBuffer, 4> {
    static constexpr const char* name() { return "end-user-action"; }
    using callback_type = void(GtkTextBuffer*, gpointer user_data);
};
template<> struct Signals<GtkTextBuffer, 5> {
...
template<> struct Signals<GtkTextBuffer, 6> {
...
template<> struct Signals<GtkTextBuffer, 9> {
...
template<> struct Signals<GtkTextBuffer, 10> {
    static constexpr const char* name() { return "modified-changed"; }
    using callback_type = void(GtkTextBuffer*, gpointer user_data);
};
template<> struct Signals<GtkTextBuffer, 11> {
...
template<> struct Signals<GtkTextBuffer, 12> {
    static constexpr const char* name() { return "remove-tag"; }
    using callback_type = void(GtkTextBuffer*, GtkTextTag* tag, GtkTextIter* start, GtkTextIter* end, gpointer user_data);
};

template<> struct Signals<GtkTextTag, 0> {
    static constexpr const char* name() { return "event"; }
    using callback_type = gboolean(GtkTextTag*, GObject* object, GdkEvent* event, GtkTextIter* iter, gpointer user_data);
};

template<> struct Signals<GtkTextTagTable, 0> {
...
template<> struct Signals<GtkTextTagTable, 1> {
...
template<> struct Signals<GtkTextTagTable, 2> {
    static constexpr const char* name() { return "tag-removed"; }
    using callback_type = void(GtkTextTagTable*, GtkTextTag* tag, gpointer user_data);
};

template<> struct Signals<GtkTextView, 0> {
    static constexpr const char* name() { return "backspace"; }
    using callback_type = void(GtkTextView*, gpointer user_data);
};
template<> struct Signals<GtkTextView, 1> {
    static constexpr const char* name() { return "copy-clipboard"; }
    using callback_type = void(GtkTextView*, gpointer user_data);
};
template<> struct Signals<GtkTextView, 2> {
    static constexpr const char* name() { return "cut-clipboard"; }
    using callback_type = void(GtkTextView*, gpointer user_data);
};
template<> struct Signals<GtkTextView, 3> {
    static constexpr const char* name() { return "delete-from-cursor"; }
    using callback_type = void(GtkTextView*, GtkDeleteType type, int count, gpointer user_data);
};
template<> struct Signals<GtkTextView, 4> {
    static constexpr const char* name() { return "extend-selection"; }
    using callback_type = gboolean(GtkTextView*, GtkTextExtendSelection granularity, GtkTextIter* location, GtkTextIter* start, GtkTextIter* end, gpointer user_data);
};
template<> struct Signals<GtkTextView, 5> {
    static constexpr const char* name() { return "insert-at-cursor"; }
    using callback_type = void(GtkTextView*, char* string, gpointer user_data);
};
template<> struct Signals<GtkTextView, 6> {
    static constexpr const char* name() { return "insert-emoji"; }
    using callback_type = void(GtkTextView*, gpointer user_data);
};
template<> struct Signals<GtkTextView, 7> {
    static constexpr const char* name() { return "move-cursor"; }
    using callback_type = void(GtkTextView*, GtkMovementStep step, int count, gboolean extend_selection, gpointer user_data);
};
template<> struct Signals<GtkTextView, 8> {
...
template<> struct Signals<GtkToolbar, 1> {
...
template<> struct Signals<GtkToolbar, 2> {
...
template<> struct Signals<GtkToolbar, 3> {
...
template<> struct Signals<GtkTreeModel, 0> {
...
template<> struct Signals<GtkTreeModel, 1> {
...
template<> struct Signals<GtkTreeModel, 2> {
    static constexpr const char* name() { return "row-has-child-toggled"; }
    using callback_type = void(GtkTreeModel*, GtkTreePath* path, GtkTreeIter* iter, gpointer user_data);
};
template<> struct Signals<GtkTreeModel, 3> {
    static constexpr const char* name() { return "row-inserted"; }
    using callback_type = void(GtkTreeModel*, GtkTreePath* path, GtkTreeIter* iter, gpointer user_data);
};
template<> struct Signals<GtkTreeModel, 4> {
...
template<> struct Signals<GtkTreeView, 10> {
    static constexpr const char* name() { return "start-interactive-search"; }
    using callback_type = gboolean(GtkTreeView*, gpointer user_data);
};
template<> struct Signals<GtkTreeView, 11> {
...
template<> struct Signals<GtkWidget, 2> {
    static constexpr const char* name() { return "button-release-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 3> {
...
template<> struct Signals<GtkWidget, 4> {
...
template<> struct Signals<GtkWidget, 10> {
    static constexpr const char* name() { return "destroy-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 11> {
...
template<> struct Signals<GtkWidget, 12> {
    static constexpr const char* name() { return "drag-begin"; }
    using callback_type = void(GtkWidget*, GdkDragContext* context, gpointer user_data);
};
template<> struct Signals<GtkWidget, 13> {
    static constexpr const char* name() { return "drag-data-delete"; }
    using callback_type = void(GtkWidget*, GdkDragContext* context, gpointer user_data);
};
template<> struct Signals<GtkWidget, 14> {
    static constexpr const char* name() { return "drag-data-get"; }
    using callback_type = void(GtkWidget*, GdkDragContext* context, GtkSelectionData* data, guint info, guint time, gpointer user_data);
};
template<> struct Signals<GtkWidget, 15> {
    static constexpr const char* name() { return "drag-data-received"; }
    using callback_type = void(GtkWidget*, GdkDragContext* context, int x, int y, GtkSelectionData* data, guint info, guint time, gpointer user_data);
};
template<> struct Signals<GtkWidget, 16> {
...
template<> struct Signals<GtkWidget, 17> {
    static constexpr const char* name() { return "drag-end"; }
    using callback_type = void(GtkWidget*, GdkDragContext* context, gpointer user_data);
};
template<> struct Signals<GtkWidget, 18> {
...
template<> struct Signals<GtkWidget, 19> {
...
template<> struct Signals<GtkWidget, 31> {
    static constexpr const char* name() { return "hide"; }
    using callback_type = void(GtkWidget*, gpointer user_data);
};
template<> struct Signals<GtkWidget, 32> {
...
template<> struct Signals<GtkWidget, 40> {
    static constexpr const char* name() { return "motion-notify-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 41> {
...
template<> struct Signals<GtkWidget, 42> {
...
template<> struct Signals<GtkWidget, 43> {
    static constexpr const char* name() { return "popup-menu"; }
    using callback_type = gboolean(GtkWidget*, gpointer user_data);
};
template<> struct Signals<GtkWidget, 44> {
    static constexpr const char* name() { return "property-notify-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 45> {
    static constexpr const char* name() { return "proximity-in-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 46> {
    static constexpr const char* name() { return "proximity-out-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 47> {
    static constexpr const char* name() { return "query-tooltip"; }
    using callback_type = gboolean(GtkWidget*, int x, int y, gboolean keyboard_mode, GtkTooltip* tooltip, gpointer user_data);
};
template<> struct Signals<GtkWidget, 48> {
    static constexpr const char* name() { return "realize"; }
    using callback_type = void(GtkWidget*, gpointer user_data);
};
template<> struct Signals<GtkWidget, 49> {
...
template<> struct Signals<GtkWidget, 53> {
    static constexpr const char* name() { return "selection-notify-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 54> {
...
template<> struct Signals<GtkWidget, 55> {
    static constexpr const char* name() { return "selection-request-event"; }
    using callback_type = gboolean(GtkWidget*, GdkEvent* event, gpointer user_data);
};
template<> struct Signals<GtkWidget, 56> {
    static constexpr const char* name() { return "show"; }
    using callback_type = void(GtkWidget*, gpointer user_data);
};
template<> struct Signals<GtkWidget, 57> {
...
template<> struct Signals<GtkWidget, 58> {
...
template<> struct Signals<GtkWidget, 59> {
...
template<> struct Signals<GtkWidget, 60> {
...
template<> struct Signals<GtkWidget, 61> {
...
template<> struct Signals<GtkWidget, 62> {
    static constexpr const char* name() { return "style-updated"; }
    using callback_type = void(GtkWidget*, gpointer user_data);
};
template<> struct Signals<GtkWidget, 63> {
...
template<> struct Signals<GtkWindow, 3> {
    static constexpr const char* name() { return "keys-changed"; }
    using callback_type = void(GtkWindow*, gpointer user_data);
};
template<> struct Signals<GtkWindow, 4> {
    static constexpr const char* name() { return "set-focus"; }
    using callback_type = void(GtkWindow*, GtkWidget* widget, gpointer user_data);
};

template<> struct Signals<GObject, 0> {
        static constexpr bool matches(const char* str) {
            return std::string_view(str, 8) == "notify::";
        }
