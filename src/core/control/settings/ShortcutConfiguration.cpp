...
actionsShortcuts({
    ...
    {Action::CUT, {{CTRL_OR_META, GDK_KEY_x}, {NONE, GDK_KEY_Cut}}},  // Name Cut
    {Action::COPY, {{CTRL_OR_META, GDK_KEY_c}, {NONE, GDK_KEY_Copy}}},  // Name Copy
    {Action::PASTE, {{CTRL_OR_META, GDK_KEY_v}, {NONE, GDK_KEY_Paste}}},  // Name Paste
    ...
    {Action::REDO, {{CTRL_OR_META & SHIFT, GDK_KEY_z}, {CTRL_OR_META, GDK_KEY_y}}}, //  Name: Redo
    {Action::ZOOM_OUT, {{CTRL_OR_META, GDK_KEY_minus}, {CTRL_OR_META, GDK_KEY_KP_Subtract}}},  // Name: Zoom out
    {Action::ZOOM_IN, {{CTRL_OR_META, GDK_KEY_plus}, {CTRL_OR_META, GDK_KEY_KP_Add}, {CTRL_OR_META, GDK_KEY_equal}}},  // Name: Zoom in
    ...
    {Action::NAV_GOTO_NEXT, {{CTRL_OR_META, GDK_KEY_Page_Down}, {CTRL_OR_META, GDK_KEY_KP_Page_Down}}},  // Name _Next Page
    {Action::NAV_GOTO_PREVIOUS, {{CTRL_OR_META, GDK_KEY_Page_Up}, {CTRL_OR_META, GDK_KEY_KP_Page_Up}}},  // Name _Previous Page
    {Action::NAV_GOTO_LAST, {{NONE, GDK_KEY_End}, {NONE, GDK_KEY_KP_End}}},  // Name _Last Page
    {Action::NAV_GOTO_FIRST, {{NONE, GDK_KEY_Home}, {NONE, GDK_KEY_KP_Home}}},  // Name _First Pages
