...
public:
    StrokeHandler(XournalView* xournal, const PageRef& page);
    ...
    auto createView(const xoj::view::Repaintable* parent) const -> std::unique_ptr<xoj::view::OverlayView> override;
