...
CoordinateSystemHandler::CoordinateSystemHandler(XournalView* xournal, const PageRef& page, bool flipShift,
                                                 bool flipControl):
 ...
 */
auto CoordinateSystemHandler::createShape(const PositionInputData& pos) -> std::pair<std::vector<Point>, Range> {
    /**
