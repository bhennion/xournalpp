...
SidebarToolbar::SidebarToolbar(SidebarToolbarActionListener* listener, GladeGui* gui): listener(listener) {
    ...
    xoj_signal_connect(this->btUp, "clicked", xoj::util::wrap_v<cb<SIDEBAR_ACTION_MOVE_UP>>, this);
    xoj_signal_connect(this->btDown, "clicked", xoj::util::wrap_v<cb<SIDEBAR_ACTION_MOVE_DOWN>>, this);
    xoj_signal_connect(this->btCopy, "clicked", xoj::util::wrap_v<cb<SIDEBAR_ACTION_COPY>>, this);
    xoj_signal_connect(this->btDelete, "clicked", xoj::util::wrap_v<cb<SIDEBAR_ACTION_DELETE>>, this);
}
