...
void Sidebar::initPages(GtkWidget* sidebarContents, GladeGui* gui) {
    ...
    for (AbstractSidebarPage* p: this->pages) {
        ...
        xoj_signal_connect_data(GTK_TOOL_BUTTON(it), "clicked", xoj::util::wrap_v<buttonClicked>,
                                new SidebarPageButton(this, i, p), xoj::util::closure_notify_cb<SidebarPageButton>,
                                GConnectFlags(0));
