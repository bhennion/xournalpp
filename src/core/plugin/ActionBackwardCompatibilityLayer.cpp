...
static const std::map<std::string_view, Action> STATELESS_ACTION_MAP = {
        ...
        {"ACTION_GOTO_FIRST"sv, Action::NAV_GOTO_FIRST},
        {"ACTION_GOTO_BACK"sv, Action::NAV_GOTO_PREVIOUS},
        {"ACTION_GOTO_PAGE"sv, Action::NAV_GOTO_PAGE},
        {"ACTION_GOTO_NEXT"sv, Action::NAV_GOTO_NEXT},
        {"ACTION_GOTO_LAST"sv, Action::NAV_GOTO_LAST},
        {"ACTION_GOTO_NEXT_ANNOTATED_PAGE"sv, Action::NAV_GOTO_NEXT_ANNOTATED_PAGE},
        {"ACTION_GOTO_PREVIOUS_ANNOTATED_PAGE"sv, Action::NAV_GOTO_PREVIOUS_ANNOTATED_PAGE},
