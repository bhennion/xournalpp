...
public:
     ...
     * @param lowerBound Beginning of the cloned path
     * @param upperBound End of the cloned path
     * @return The clone
     */
     ...
     */
    virtual xoj::util::Rectangle<double> getThinBoundingBox() const = 0;

    /**
     * @brief Compute the smallest box containing the a subsection of the path. No width taken into account
     * @return The thin bounding box
     */
    virtual xoj::util::Rectangle<double> getSubSectionThinBoundingBox(const Parameter& startParam,
                                                                      const Parameter& endParam) const = 0;
    ...
    virtual void addSectionToCairo(cairo_t* cr, const Parameter& lowerBound, const Parameter& upperBound) const = 0;
