...
public:
     ...
     */
    xoj::util::Rectangle<double> getThinBoundingBox() const override;

    /**
     * @brief Compute the smallest box containing the a subsection of the path. No width taken into account
     * @return The thin bounding box
     */
    xoj::util::Rectangle<double> getSubSectionThinBoundingBox(const Parameter& startParam,
                                                              const Parameter& endParam) const override;
    ...
    void addSectionToCairo(cairo_t* cr, const Parameter& lowerBound, const Parameter& upperBound) const override;
